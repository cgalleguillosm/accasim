...
# -*- coding: utf-8 -*-
#
# AccaSim documentation build configuration file, created by
...
import os
import sys
sys.path.insert(0, os.path.abspath('D:\\Programas\\git\\accasim'))
...
latex_documents = [
    (master_doc, 'AccaSim.tex', 'AccaSim Documentation',
